...
**Solver Class** Is a Class that contains methods for doing factorial operations, string reversal and the fizzbuzz challenge.
...
```sh
  cd project-folder
  git clone https://github.com/Felipe-Perez-Ferraro/TDD.git
```
...
Feel free to check the [issues page](https://github.com/Felipe-Perez-Ferraro/TDD/issues).
